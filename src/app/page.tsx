      ...
      <section className="py-16 px-8 md:px-12 bg-primary">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-xl text-white/90 mb-10 max-w-3xl">
            Chaque couteau est une pièce unique, façonnée avec soin. Trouvez
            celui qui vous accompagnera au quotidien.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
            ...
            <div className="bg-dark rounded-xl overflow-hidden shadow-lg">
              ...
              <div className="p-6">
                ...
                <p className="text-white/80">
                  Bois de fer, lame en acier poli, pliant
                </p>
              </div>
            </div>
            ...
            <div className="bg-dark rounded-xl overflow-hidden shadow-lg">
              ...
              <div className="p-6">
                ...
                <p className="text-white/80">
                  Bois de santal, acier carbone, guillochage
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          <div className="max-w-2xl">
            ...
            >
              ...
              <div>
                <label htmlFor="prenom" className="block text-white mb-2">
                  Prénom
                </label>
                <input
                  type="text"
